...
2. **Configure Modules** → Select server, then check modules you want:
   ...
   ▶ ☑ Core System (5m) - CUDA, Python, Node.js, Docker
     ...
     ☐ Small Models (7B) (8m) - Mistral, Llama 3.3 8B, Qwen 2.5 7B
     ☐ Medium Models (14-34B) (25m) - Qwen 2.5 14B, Mixtral 8x7B, DeepSeek Coder
     ☐ Large Models (70B+) (40m) - Llama 3.3 70B, Qwen 2.5 72B
...
qwen2.5:7b            ghi789          4.4 GB    2 hours ago
```
