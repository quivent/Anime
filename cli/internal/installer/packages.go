...
func GetPackages() map[string]*Package {
	return map[string]*Package{
		"core": {
			ID:           "core",
			Name:         "Core System",
			Description:  "Build tools, server essentials: gcc, git, curl, jq, ripgrep, rsync, sqlite3, nginx, certbot, fail2ban, ufw",
			Dependencies: []string{},
		...
		"rust": {
			ID:           "rust",
			Name:         "Rust Toolchain",
			Description:  "Rust compiler, cargo, and common tools (rustup)",
			Dependencies: []string{},
			EstimatedTime: 3 * time.Minute,
			Category:     "Runtime",
			Size:         "~500MB",
		...
		"gh": {
			ID:           "gh",
			Name:         "GitHub CLI",
			Description:  "Official GitHub CLI for repos, PRs, issues, and actions",
			Dependencies: []string{},
		...
		"uv": {
			ID:           "uv",
			Name:         "uv",
			Description:  "Extremely fast Python package manager and virtualenv tool",
			Dependencies: []string{},
			EstimatedTime: 1 * time.Minute,
			Category:     "Runtime",
			Size:         "~30MB",
		...
		"tmux": {
			ID:           "tmux",
			Name:         "tmux",
			Description:  "Terminal multiplexer — persist sessions over SSH disconnects",
			Dependencies: []string{},
			EstimatedTime: 1 * time.Minute,
			Category:     "Tool",
			Size:         "~2MB",
		...
		"htop": {
			ID:           "htop",
			Name:         "htop & btop",
			Description:  "Interactive process viewers for CPU, memory, and GPU monitoring",
			Dependencies: []string{},
			EstimatedTime: 1 * time.Minute,
			Category:     "Tool",
			Size:         "~5MB",
		...
		"glow": {
			ID:           "glow",
			Name:         "Glow",
			Description:  "Terminal markdown renderer — render READMEs and docs in the shell",
			Dependencies: []string{},
			EstimatedTime: 1 * time.Minute,
			Category:     "Tool",
			Size:         "~10MB",
		...
		"jq": {
			ID:           "jq",
			Name:         "jq & yq",
			Description:  "JSON and YAML processors for shell scripting",
			Dependencies: []string{},
			EstimatedTime: 1 * time.Minute,
			Category:     "Tool",
			Size:         "~5MB",
		...
		"fzf": {
			ID:           "fzf",
			Name:         "fzf",
			Description:  "Fuzzy finder — search files, history, processes interactively",
			Dependencies: []string{},
			EstimatedTime: 1 * time.Minute,
			Category:     "Tool",
			Size:         "~5MB",
		...
		"bat": {
			ID:           "bat",
			Name:         "bat & eza",
			Description:  "Modern replacements for cat and ls with syntax highlighting",
			Dependencies: []string{},
			EstimatedTime: 1 * time.Minute,
			Category:     "Tool",
			Size:         "~10MB",
		...
		"lazygit": {
			ID:           "lazygit",
			Name:         "lazygit",
			Description:  "Terminal UI for git — stage, commit, push, resolve conflicts visually",
			Dependencies: []string{},
			EstimatedTime: 1 * time.Minute,
			Category:     "Tool",
			Size:         "~10MB",
		...
		"neovim": {
			ID:           "neovim",
			Name:         "Neovim",
			Description:  "Modern Vim with Lua config and LSP support",
			Dependencies: []string{},
			EstimatedTime: 2 * time.Minute,
			Category:     "Tool",
			Size:         "~50MB",
		...
		"caddy": {
			ID:           "caddy",
			Name:         "Caddy",
			Description:  "Web server with automatic HTTPS — simpler alternative to nginx + certbot",
			Dependencies: []string{},
			EstimatedTime: 1 * time.Minute,
			Category:     "Application",
			Size:         "~40MB",
		...
		"tailscale": {
			ID:           "tailscale",
			Name:         "Tailscale",
			Description:  "Zero-config VPN mesh — connect machines without exposing ports",
			Dependencies: []string{},
			EstimatedTime: 1 * time.Minute,
			Category:     "Application",
			Size:         "~30MB",
		...
		"wanmodels": {
			...
			Dependencies:  []string{"comfyui", "wantorch"},
		...
		"comfort": {
			...
			Dependencies:  []string{"nodejs", "comfyui"},
			EstimatedTime: 8 * time.Minute,
			Category:      "Application",
			Size:          "~400MB",
		},
		"wan": {
			...
			EstimatedTime: 76 * time.Minute, // sum of sequential deps: comfyui(15)+wantorch(5)+wannodes(3)+wanmodels(45)+comfort(8)
			Category:      "Bundle",
			Size:          "~91GB",
		},
